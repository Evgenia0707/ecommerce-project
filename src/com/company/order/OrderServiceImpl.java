...
import com.company.ckechout.CheckoutService;
import com.company.ckechout.CustomerBalanceCheckoutServiceImpl;
import com.company.ckechout.MixPaymentCheckoutServiceImpl;
...
public class OrderServiceImpl implements OrderService {
    ...
    public String placeOrder(Cart cart) {
        ...
        if (checkoutResult){ //if checkout done -> create order
